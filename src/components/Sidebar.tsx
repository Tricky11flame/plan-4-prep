  ...
  return (
    <aside className="w-full lg:w-1/3 xl:w-1/4 p-6 bg-white border-[1.5pt] border-black flex flex-col"> 
      ...
      <h1 className="text-2xl text-gray-900 mb-1  font-mono ">
        <div className='text-4xl text-blue-500'><img src="https://ik.imagekit.io/ksepigjsl/Adobe%20Express%20-%20file.png?updatedAt=1760812938714" alt="P4P Logo" className="h-14   bg-black rounded-full p-1 mb-4 mx-4"/>@plan<span className='text-red-500'>4</span>prepp.</div> </h1>
